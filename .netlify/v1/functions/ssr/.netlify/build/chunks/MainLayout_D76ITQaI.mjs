import { c as createAstro, a as createComponent, b as addAttribute, i as renderHead, d as renderTemplate, m as maybeRenderHead, s as spreadAttributes, e as renderComponent, F as Fragment, u as unescapeHTML, j as renderScript, r as renderSlot } from './astro/server_Bjo-g0z2.mjs';
import 'kleur/colors';
import 'clsx';
...
import { a as actions } from './_astro_actions_Bso-LI2H.mjs';
/* empty css                         */
import { i as isInputError } from './shared_Dh4QwzlU.mjs';
...
const $$ContactFormResend = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$1 || (_a$1 = __template$1(["<!-- Contact section -->", `<section id="contact" data-astro-cid-hgas65sd> <div class="contact-wrapper" data-astro-cid-hgas65sd> <div data-astro-cid-hgas65sd> <!-- Contact text --> <h2 data-astro-cid-hgas65sd>Get in touch.</h2> <div class="hr-div" data-astro-cid-hgas65sd></div> <p class="subheading" data-astro-cid-hgas65sd>
I'm ready to join your team! Send me a message if you think we'd be a great fit!
</p> </div> <!-- Contact form --> <div data-astro-cid-hgas65sd> <form`, ' method="post" data-astro-cid-hgas65sd> <label data-astro-cid-hgas65sd>Username<input type="text" name="username" placeholder="Username" required', " data-astro-cid-hgas65sd> </label> ", ' <label data-astro-cid-hgas65sd>Email<input type="email" name="email" placeholder="Email" required', " data-astro-cid-hgas65sd> </label> ", ` <button data-astro-cid-hgas65sd>Send</button> </form> <!-- <form name="contact-form" id="contact-form" action={actions.send} method="POST">
            <input type="hidden" name="access_key" value="a11bce5f-44db-4845-b3d7-74506ba572a8">
            <input type="hidden" name="redirect" value="https://nickbravo.dev/success"> --> <!-- Name input --> <!-- <div>
            ...
            </div> --> <!-- Submit button --> <!-- <div class="h-captcha"
              data-captcha="true"
              data-theme="dark">
            </div>
            <div>
          ...
          </form> --> </div> </div> </section> <!-- <script src="https://web3forms.com/client/script.js" async defer><\/script> --> <!-- <script is:inline>
    ...
    <\/script> --> `])), maybeRenderHead(), addAttribute(actions.send, "action"), addAttribute(inputErrors.username ? "username-error" : void 0, "aria-describedby"), inputErrors.username && renderTemplate`<p id="username-error" data-astro-cid-hgas65sd>${inputErrors.username[0]}</p>`, addAttribute(inputErrors.email ? "email-error" : void 0, "aria-describedby"), inputErrors.email && renderTemplate`<p id="email-error" data-astro-cid-hgas65sd>${inputErrors.email[0]}</p>`);
}, "/Users/nb258622/Maverik CREATE Dept. Dropbox/Nick Bates/dev/Github/nickbravodev-v2/src/components/forms/ContactFormResend.astro", void 0);
