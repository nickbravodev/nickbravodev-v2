import { c as createComponent, a as createAstro, e as renderComponent, i as renderScript, d as renderTemplate, b as addAttribute, j as renderHead, m as maybeRenderHead, s as spreadAttributes, F as Fragment, u as unescapeHTML, r as renderSlot } from './astro/server_D5xLaq5v.mjs';
import 'kleur/colors';
import 'clsx';
...
import $$ContactFormResend from './ContactFormResend_HSaM6KOv.mjs';
/* empty css                          */
...
const $$Index$1 = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "vercel-analytics", "vercel-analytics", { "data-props": propsStr, "data-params": paramsStr, "data-pathname": Astro2.url.pathname })} ${renderScript($$result, "/Users/nickbates/Sync/development/nickbravodev-v2/node_modules/@vercel/analytics/dist/astro/index.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/nickbates/Sync/development/nickbravodev-v2/node_modules/@vercel/analytics/dist/astro/index.astro", void 0);
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  const propsStr = JSON.stringify(Astro2.props);
  const paramsStr = JSON.stringify(Astro2.params);
  return renderTemplate`${renderComponent($$result, "vercel-speed-insights", "vercel-speed-insights", { "data-props": propsStr, "data-params": paramsStr, "data-pathname": Astro2.url.pathname })} ${renderScript($$result, "/Users/nickbates/Sync/development/nickbravodev-v2/node_modules/@vercel/speed-insights/dist/astro/index.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/nickbates/Sync/development/nickbravodev-v2/node_modules/@vercel/speed-insights/dist/astro/index.astro", void 0);
...
const { twj: twj$6 } = await import('tw-to-css');

const { twj: twj$5 } = await import('tw-to-css');

const { twj: twj$4 } = await import('tw-to-css');

const { twj: twj$3 } = await import('tw-to-css');

const { twj: twj$2 } = await import('tw-to-css');

const { twj: twj$1 } = await import('tw-to-css');
...
const $$MainHead = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<head><meta charset="utf-8"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="viewport" content="width=device-width"><meta name="generator"${addAttribute(Astro2.generator, "content")}><!-- Static Site Generated by Astro - https://astro.build --><title>${`${title} - ${title_tag}`}</title><link rel="canonical"${addAttribute(canonicalURL, "href")}><link rel="sitemap" href="/sitemap-index.xml"><meta name="description"${addAttribute(description, "content")}><meta name="color-scheme" content="dark light"><!-- <SEO
      openGraph={
        {
          basic: {
            title: title,
...
}, "/Users/nickbates/Sync/development/nickbravodev-v2/node_modules/astro-icon/components/Icon.astro", void 0);
...
}, "/Users/nickbates/Sync/development/nickbravodev-v2/src/components/Link.astro", void 0);
...
</div> </footer> ${renderScript($$result, "/Users/nickbates/Sync/development/nickbravodev-v2/src/components/Footer.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/nickbates/Sync/development/nickbravodev-v2/src/components/Footer.astro", void 0);
...
}, "/Users/nickbates/Sync/development/nickbravodev-v2/src/components/ResumeExperience.astro", void 0);
...
const $$ResumePopout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(["<!-- Off-canvas resume popout -->", '<section class="resume-popout" tabindex="-1" id="resume" data-visible="false" data-astro-cid-iyzdqnlb> <div class="popout-wrapper" data-astro-cid-iyzdqnlb><div class="popout" data-astro-cid-iyzdqnlb> <!-- Resume header --> <div class="popout-header" data-astro-cid-iyzdqnlb> <!-- Brand logo --> <a href="/" class="popoutbar-brand" aria-label="NickBravo.dev Logo" data-astro-cid-iyzdqnlb> ', ' </a> <!-- Resume header text --> <div class="ms-3 me-auto" data-astro-cid-iyzdqnlb> <h2 class="resume-heading" data-astro-cid-iyzdqnlb>Nick Bravo</h2> <p class="resume-subheading" data-astro-cid-iyzdqnlb>\nPrinciplal Frontend Engineer\n</p> </div> <!-- Close button --><!-- Close button --> <button type="button" class="btn-close text-reset" aria-label="Close" data-astro-cid-iyzdqnlb> ', ' </button> </div> <!-- Resume body --> <div id="resume-body" class="popout-body" data-astro-cid-iyzdqnlb> <!-- Performance profile --> <div class="profile" data-astro-cid-iyzdqnlb> <h3 data-astro-cid-iyzdqnlb>PROFESSIONAL SUMMARY</h3> <p data-astro-cid-iyzdqnlb>\nPrincipal Frontend Engineer with 15+ years of experience driving digital transformation through scalable, high-performance websites. Expert in Astro, React, TypeScript, JavaScript, Tailwind CSS, Node.js, and modern web standards including accessibility, Core Web Vitals, and SEO. Proven ability to align engineering, design, and marketing to deliver measurable business impact.\n</p> </div> <!-- Work experience --> <div class="experience" data-astro-cid-iyzdqnlb> <h3 data-astro-cid-iyzdqnlb>EXPERIENCE</h3> ', ' <!-- Education history --> <h3 data-astro-cid-iyzdqnlb>EDUCATION</h3> <h4 data-astro-cid-iyzdqnlb>Bachelor Of Science | Digital Cinematography</h4> <h5 data-astro-cid-iyzdqnlb>Full Sail University</h5> <ul data-astro-cid-iyzdqnlb> <li data-astro-cid-iyzdqnlb>GPA 3.99 | Valedictorian</li> </ul> <!-- <p>&nbsp;</p> --> <h4 data-astro-cid-iyzdqnlb>Associate Of Applied Science | Graphic Design</h4> <h5 data-astro-cid-iyzdqnlb>College Of Eastern Utah</h5> </div> <!-- Resume skills breakdown --> <div class="skills" data-astro-cid-iyzdqnlb> <h3 data-astro-cid-iyzdqnlb>AREAS OF EXPERTISE</h3> <ul data-astro-cid-iyzdqnlb> <li data-astro-cid-iyzdqnlb>HTML / CSS</li> <li data-astro-cid-iyzdqnlb>JavaScript</li> <li data-astro-cid-iyzdqnlb>TypeScript</li> <li data-astro-cid-iyzdqnlb>React</li> <li data-astro-cid-iyzdqnlb>Git and CI/CD</li> <li data-astro-cid-iyzdqnlb>Headless CMS</li> <li data-astro-cid-iyzdqnlb>API Integration</li> <li data-astro-cid-iyzdqnlb>Responsive Design</li> <li data-astro-cid-iyzdqnlb>Design Systems</li> <li data-astro-cid-iyzdqnlb>Web Performance</li> <li data-astro-cid-iyzdqnlb>Core Web Vitals</li> <li data-astro-cid-iyzdqnlb>Web Accessibility</li> <li data-astro-cid-iyzdqnlb>SEO Best Practices</li> <li data-astro-cid-iyzdqnlb>SCSS / SASS</li> <li data-astro-cid-iyzdqnlb>PostCSS</li> <li data-astro-cid-iyzdqnlb>Tailwind CSS</li> <li data-astro-cid-iyzdqnlb>Node.js</li> <li data-astro-cid-iyzdqnlb>UI/UX Design</li> <li data-astro-cid-iyzdqnlb>Figma</li> <li data-astro-cid-iyzdqnlb>Adobe CC</li> </ul> </div> </div> <div class="resume-download" data-astro-cid-iyzdqnlb> <a href="/resume/NickBravoPrincipalFrontendEngineerResume.pdf" target="_blank" aria-label="Download Resume" data-astro-cid-iyzdqnlb> ', ` </a> </div> </div> </div> </section> <script>
...
}, "/Users/nickbates/Sync/development/nickbravodev-v2/src/components/ResumePopout.astro", void 0);
